Feature: CreateCustomerFeature
As a user,
In order to mange customer,
I need to be able create customer
...
Scenario: Customer with null firstName should be rejected
	Given I enter following values for new customer
		| FirstName | LastName  | DateOfBirth | PhoneNumber   | Email                   | BankAccountNumber                 |
		|           | Allahyari | 1984-04-11  | +989123491682 | allahyari3631@gmail.com | FR76 3000 6000 0112 3456 7890 189 |
	When I press Submit button
...
Scenario: Customer with null lastName should be rejected
	Given I enter following values for new customer
		| FirstName | LastName | DateOfBirth | PhoneNumber   | Email                   | BankAccountNumber                 |
		| Roya      |          | 1984-04-11  | +989123491682 | allahyari3631@gmail.com | FR76 3000 6000 0112 3456 7890 189 |
	When I press Submit button
...
Scenario: Customer with null email address should be rejected
	Given I enter following values for new customer
		| FirstName | LastName  | DateOfBirth | PhoneNumber   | Email | BankAccountNumber                 |
		| Roya      | Allahyari | 1984-04-11  | +989123491682 |       | FR76 3000 6000 0112 3456 7890 189 |
	When I press Submit button
...
Scenario: Customer with null bank account number should be rejected
	Given I enter following values for new customer
		| FirstName | LastName  | DateOfBirth | PhoneNumber   | Email                   | BankAccountNumber |
		| Roya      | Allahyari | 1984-04-11  | +989123491682 | allahyari3631@gmail.com |                   |
	When I press Submit button
...
Scenario Outline: Create Customer
	...
	Examples:
		...
		| ""        | Allahyari | 1984-04-11  | +989123491682  | allahyari3631@gmail.com | FR76 3000 6000 0112 3456 7890 189 | FirstNameRequiredException         |
		| Roya      | ""        | 1984-04-11  | +989123491682  | allahyari3631@gmail.com | FR76 3000 6000 0112 3456 7890 189 | LastNameRequiredException          |
		| Roya      | Allahyari | 1984-04-11  | 00989123491682 | allahyari3631@gmail.com | FR76 3000 6000 0112 3456 7890 189 | InvalidPhoneNumberException        |
		| Roya      | Allahyari | 1984-04-11  |                | allahyari3631@gmail.com | FR76 3000 6000 0112 3456 7890 189 | PhoneNumberRequiredException       |
		| Roya      | Allahyari | 1984-04-11  | +989123491682  | allahyari3631.com       | FR76 3000 6000 0112 3456 7890 189 | InvalidEmailException              |
		| Roya      | Allahyari | 1984-04-11  | +989123491682  | ""                      | FR76 3000 6000 0112 3456 7890 189 | EmailRequiredException             |
		| Roya      | Allahyari | 1984-04-11  | +989123491682  | allahyari3631@gmail.com | 1234567890                        | InvalidBankAccountNumberException  |
		| Roya      | Allahyari | 1984-04-11  | +989123491682  | allahyari3631@gmail.com | ""                                | BankAccountNumberRequiredException |